...
public class ProductController {
	...
	public String index(Model model) {
		...
		return listByPage(model, 1, null, null);
	}
	...
	public String listByPage(Model model, @PathVariable("pageNumber") int currentPage,
		...
		//------------ Sản Phẩm ------------------------------------------------------------ //
		Page<Product> page = productService.listAllSort(currentPage, sort, keyword); 
	...
	@GetMapping("/category/page/{pageNumber}")     //   page/1 => PathVariable("Tên trong view")---page=1 => request()
	public String listByPageCategory(Model model, @PathVariable("pageNumber") int currentPage,
		...
		//------------ Sản Phẩm ------------------------------------------------------------ //
		Page<Product> page = productService.listSortByCategory(currentPage, idCategory); 
		List<Product> ls = page.getContent(); //lấy sản phẩm của trang chọn
