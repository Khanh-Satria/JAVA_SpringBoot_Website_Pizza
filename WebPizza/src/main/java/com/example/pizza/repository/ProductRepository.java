...
public interface ProductRepository extends PagingAndSortingRepository<Product, Integer>{
		...
		@Query(value = "select sp.*,sum(ct.So_luong) as tsl from sanpham sp "
				+ "inner join cthoadon ct on ct.masp = sp.masp group by 1 order by tsl desc limit 0,?;", nativeQuery=true)
